...
def test_spotify_main():
    ...
    spotify_files_raw = [
        ...
        f"spotify_year_plot_{username}.html",
        f"spotify_daily_plot_{username}.html",
        f"spotify_popularity_plot_{username}.html",
        f"spotify_genre_plot_{username}.html",
        f"spotify_top_songs_{username}.html",
    ]
