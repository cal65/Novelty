...
class ExportData(models.Model):
    ...
    shelf1 = models.CharField(max_length=250, blank=True)
    shelf2 = models.CharField(max_length=250, blank=True)
    shelf3 = models.CharField(max_length=250, blank=True)
    shelf4 = models.CharField(max_length=250, blank=True)
    shelf5 = models.CharField(max_length=250, blank=True)
    shelf6 = models.CharField(max_length=250, blank=True)
    shelf7 = models.CharField(max_length=250, blank=True)
