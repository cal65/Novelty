...
class ExportData(models.Model):
    ...
    shelf1 = models.CharField(max_length=250, blank=True, null=True)
    shelf2 = models.CharField(max_length=250, blank=True, null=True)
    shelf3 = models.CharField(max_length=250, blank=True, null=True)
    shelf4 = models.CharField(max_length=250, blank=True, null=True)
    shelf5 = models.CharField(max_length=250, blank=True, null=True)
    shelf6 = models.CharField(max_length=250, blank=True, null=True)
